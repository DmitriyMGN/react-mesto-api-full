...
function Header (props) {
  ...
  <header className="header">
    ...
    <div className="navbar">
      {location.pathname === '/signin' && <Link className="navbar__element" to="/sign-up">Регистрация</Link> }
      {location.pathname === '/signup' && <Link className="navbar__element" to="/sign-in">Войти</Link> }
